# checkpoint 15
def check_15(handles:, maximum_score:, resources:)
  ...
  log_filters = [
    ...
    'protoPayload.serviceData.jobCompletedEvent.job.jobConfiguration.query.destinationTable.tableId="improv_table"'
  ]
  ...
  if query_logs.count > 0
    ret_hash = { :score => maximum_score, :message => '성공적으로 improv_table 생성되었습니다.', :student_message => '성공적으로 improv_table 생성되었습니다.' }
  else
