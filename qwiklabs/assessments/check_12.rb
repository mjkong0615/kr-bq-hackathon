# method description
def check_12(handles:, maximum_score:, resources:)
  bigquery = handles['project_0.BigqueryV2']
  ret_hash = { :score => 0, :message => "", :student_message => "" }
  isAvailable = false

  begin
    final_personalized_recommendations_object = bigquery.get_table("cymbal".to_s, "final_personalized_recommendations".to_s ) || []
  rescue 
    isAvailable = false
  end 

  if final_personalized_recommendations_object
    isAvailable = true
  end 
