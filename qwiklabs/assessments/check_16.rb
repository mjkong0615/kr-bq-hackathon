# checkpoint 15 #task4-2
def check_16(handles:, maximum_score:, resources:)
  ...
  log_filters = [
    ...
    'protoPayload.serviceData.jobCompletedEvent.extract.destinationUris="gs://'+ logging.project + '-bucket/task4_result/customer_review_enf_result"'
  ]
  ...
  if query_logs.count > 0
    ret_hash = { :score => maximum_score, :message => '성공적으로 customer_review_enf_result이 생성되었습니다.', :student_message => '성공적으로 improv_tabcustomer_review_enf_result이 생성되었습니다.' }
  else
